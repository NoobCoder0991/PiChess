...
function decodeBestMove(algebraicNotation) {
  ...
  if (algebraicNotation === "O-O") {
    ...
    return { startIndex: 4, targetIndex: 6, flag: 0 }; // Assuming standard board indexing
  } else if (algebraicNotation === "O-O-O") {
    // Queen-side castling for white
    return { startIndex: 4, targetIndex: 2, flag: 0 }; // Assuming standard board indexing
  } else if (algebraicNotation === "o-o") {
    // King-side castling for black
    return { startIndex: 60, targetIndex: 62, flag: 0 }; // Assuming standard board indexing
  } else if (algebraicNotation === "o-o-o") {
    // Queen-side castling for black
    return { startIndex: 60, targetIndex: 58, flag: 0 }; // Assuming standard board indexing
  }
  ...
  if (algebraicNotation.length === 5) {
    ...
    return { startIndex, targetIndex, flag: promotionFlag };
  }
